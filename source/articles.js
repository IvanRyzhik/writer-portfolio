export const articles = [
  ...
  },
  {
    ...
    preview:
      'Before you hit the road, double-check you’ve got snacks, water, and something good queued up to listen to. And if you’ve ever spent hours searching for the best audiobooks for road trips or wondered about the easiest way to access content on the go, we’ve found some of the most amazing books and tools to check out.',
    source:
      'https://hnmagazine.co.uk/features/best-audiobooks-for-road-trips-family-friendly-picks/',
    remoteAccess: true,
  },
  {
    id: 8,
    src: '/images/preview-8.png',
    title: 'Top Areas of Personal Growth for Career Success in 2025',
    preview:
    ...
    source:
      'https://www.theindustryleaders.org/post/top-areas-of-personal-growth-for-career-success-in-2025',
    remoteAccess: true,
  },
  {
    id: 9,
    src: '/images/preview-9.png',
    title: 'Books to Inspire Travel: Your next destination awaits',
    preview:
  ...
  {
    id: 10,
    src: '/images/preview-10.png',
    title: 'Benefits of Microlearning vs. Traditional Training Methods',
    preview:
    ...
    source:
      'https://www.sciencetimes.com/articles/60559/20250825/benefits-microlearning-vs-traditional-training-methods.htm',
    remoteAccess: false,
  },
  {
    id: 11,
    src: '/images/preview-11.png',
    title: 'Benefits of Microlearning vs. Traditional Training Methods',
    preview:
      'Ever felt like you can’t even sit through a single sitcom episode anymore because you get bored and you get this urgent need to check your phone? Turns out, dopamine is partly to blame, but luckily, you can use the benefits of microlearning to take control of your attention.',
